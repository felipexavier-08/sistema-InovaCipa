<?php    
    ...
    require_once __DIR__ . "/controllers/AtaEmailController.php";
    ...
    $ataEmailController = new AtaEmailController();
   ...
   switch($url) {
        ...
        case "/code/cipa_t1/ata/enviar":
            // Verificar se é admin
            if (!isset($_SESSION['funcionario_logado']) || $_SESSION['funcionario_logado']['adm_funcionario'] != 1) {
                header("Location: /code/cipa_t1/login");
                exit;
            }
            $ataEmailController->enviarAtaParaFuncionarios($requisicao);
            break;
